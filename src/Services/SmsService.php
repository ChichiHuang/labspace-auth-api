...
class SmsService {
	...
	static public function sendSmsMessage($phone, $msg)
	{
        ...
        $sms_url = config('labspace-auth-api.sms.mitake.url').'?CharsetURL=UTF-8&username='.$username.'&password='.$password.'&dstaddr='.$phone.'&DestName='.env('WEBSITE_NAME').'&dlvtime=10&vldtime=660&smbody='.$msg;
